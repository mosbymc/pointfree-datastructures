...
import { constant, defaultPredicate, delegatesFrom, delegatesTo, generatorProto, identity, ifElse, invoke, isArray, isString, noop, not, sortDirection, when, wrap } from './util';
