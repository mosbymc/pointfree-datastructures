import * as monads from '../../src/dataStructures';
...
describe('Maybe functor tests', function _testMaybeFunctor() {
    ...
    describe('Maybe data structure implementation tests', function _testMaybeFunctorObject() {
        ...
        it('should return \'true\' when isEmpty is invoked on a Nothing', function _testIsEmptyOnNothing() {
            Maybe.Nothing().isEmpty().should.be.true;
        });

        it('should return \'false\' when isEmpty is invoked on a Just', function _testIsEmptyOnJust() {
            Maybe.Just().isEmpty().should.be.false;
        });
