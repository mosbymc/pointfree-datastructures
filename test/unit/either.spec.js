...
describe('Either data structure tests', function _testEitherDataStructure() {
    ...
    describe('Either functor object tests', function _testEitherDataStructure() {
        ...
        it('should return \'true\' when isEmpty is invoked on a Left', function _testIsEmptyOnLeft() {
            Either.Left().isEmpty().should.be.true;
        });

        it('should return \'false\' when isEmpty is invoked on a Right', function _testIsEmptyOnRight() {
            Either.Right().isEmpty().should.be.false;
        });
